...
?>
        ...
        <h2 class="text-xl text-black my-3 font-bold">Don't have an account? <br /> You can <a href="http://unified.test/register/" style="color:#4461F2">register here!</a></h2>
        <div class="signindiv mt-5">
            ...
            <form id="loginform" action="<?php echo wp_login_url(home_url()); ?>" method="post">
                ...
                <a href="http://unified.test/wp-login.php?loginSocial=google" data-plugin="nsl" data-action="connect" data-redirect="current" data-provider="google" data-popupwidth="600" data-popupheight="600" >
                ...
                <a href="http://unified.test/wp-login.php?loginSocial=twitter" data-plugin="nsl" data-action="connect" data-redirect="current" data-provider="twitter" data-popupwidth="600" data-popupheight="600">
