...
class Enqueue {
    ...
    function enqueueStyles() {
        ...
        // wp_enqueue_script('see-more', get_template_directory_uri() . '/assets/js/parts/see-more.js', array('jquery'), null, true);
        // wp_enqueue_script('navigation', get_template_directory_uri() . '/assets/js/parts/navigation.js', array('jquery'), null, true);
    }
