...
if (get_row_layout() == 'card') {
    ...
    <div class="relative bg-gray-100 rounded-lg shadow-md overflow-hidden mx-4 my-4 " style="width: 330px; height: 400px; margin:auto">
        <div class="absolute inset-0 bg-cover bg-center " style="background-image: url('https://images.unsplash.com/photo-1713354409506-53edfd407d49?q=80&w=1587&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D');">
