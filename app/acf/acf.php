...
add_action('acf/include_fields', function () {
    ...
    'sub_fields' => array(
        array(
            'key' => 'field_668da3b98a49f',
            'label' => 'Stats Title',
            'name' => 'stats_title',
            'type' => 'text',
            'instructions' => 'Enter the title for the stats module.',
            'required' => 0,
        ),
        array(
            ...
            'sub_fields' => array(
                array(
                    ...
                    'type' => 'text',
                    'instructions' => 'Enter the statistic value (numbers, letters, and symbols allowed).',
                    'required' => 0,
                    'wrapper' => array(
                        'width' => '',
                        'class' => '',
    ...
    'sub_fields' => array(
        array(
            ...
            'name' => 'infocards',
            'type' => 'repeater',
            'instructions' => 'Add one or more infocards.',
            'required' => 1,
            'sub_fields' => array(
                array(
